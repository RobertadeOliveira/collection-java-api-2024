...
public class ListaTarefa {
  ...
  public static void main(String[] args) {
    ...
    listaTarefa.adicionarTarefa("Comprar azeite");
    listaTarefa.adicionarTarefa("Estudar para o concurso");
    listaTarefa.adicionarTarefa("Fazer as listas");
    ...
    listaTarefa.removerTarefa("Estudar para o  concurso");
