...
public class ConjuntoConvidados {
  ...
  public void removerConvidadoPorCodigoConvite(int codigoConvite) {
    ...
    if (!convidadosSet.isEmpty()) {
      ...
      throw new RuntimeException("Não tem convidados para remover no set!");
    }
  }
  ...
  public void exibirConvidados() {
    if (!convidadosSet.isEmpty()) {
      ...
      System.out.println("Não tem convidados no set!");
    }
  }
  ...
  public static void main(String[] args) {
    ...
    conjuntoConvidados.adicionarConvidado("Kamila", 1234);
    conjuntoConvidados.adicionarConvidado("Milena", 1235);
    conjuntoConvidados.adicionarConvidado("Kadu", 1235);
